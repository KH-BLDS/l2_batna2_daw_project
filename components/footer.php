<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>Contact Us.</h3>
         <a href="tel:9800000000"><i class="fas fa-phone"></i> +213 66614 00 00</a>
         <a href="khaled.beladis@etu.univ-batna2.dz"><i class="fas fa-envelope"></i>
            khaled.beladis@etu.univ-batna2.dz</a>
         <a href="https://maps.app.goo.gl/qCYdSZcGgiNwbUuS7"><i class="fas fa-map-marker-alt"></i> Batna, Algeria</a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>KHALED BELADIS</span> | all rights reserved!</div>
