...
<body>
   ...
   <section class="products shopping-cart">
         ...
         if ($select_cart->rowCount() > 0) {
            while ($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)) {
               ...
               <form action="" method="post" class="box">
                  ...
                  <div class="flex">
                     <div class="price"><?= number_format($fetch_cart['price'], 2, '.', ','); ?> DZD</div>
                  ...
                  <div class="sub-total"> Sub Total :
                     <span><?= number_format($sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']), 2, '.', '') ?>DZD</span>
                  </div>
      ...
      <div class="cart-total">
         <p>Grand Total :<span><?= number_format($grand_total, 2, '.', ''); ?> DZD</span></p>
