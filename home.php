...
<body>
   ...
   <script>
      ...
      var swiperCategory = new Swiper(".category-slider", {
         ...
         spaceBetween: 20,
         navigation: {
            nextEl: ".category-slider .swiper-button-next-category",
            prevEl: ".category-slider .swiper-button-prev-category",
         },
         pagination: {
      ...
      var swiperProducts = new Swiper(".products-slider", {
         ...
         spaceBetween: 20,
         navigation: {
            nextEl: ".products-slider .swiper-button-next-products",
            prevEl: ".products-slider .swiper-button-prev-products",
         },
         pagination: {
